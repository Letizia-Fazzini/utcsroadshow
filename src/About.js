...
export default class About extends Component {
  render() {
    ...
    let whycs = "Computer Science teaches logical thinking and methodical problem solving. Having tech skills can open up many future opportunities, and it's also lots of fun."
